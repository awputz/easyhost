      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="prose prose-invert prose-zinc max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-400 mb-4">You agree not to use the Service to:</p>
            <ul className="list-disc list-inside text-zinc-400 mb-4 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-white mb-4">7. Payment and Billing</h2>
            <p className="text-zinc-400 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-400 mb-4">
              ...
              <a href="mailto:legal@pagelink.com" className="text-blue-400 hover:underline">
                legal@pagelink.com
              </a>
            </p>
          </section>
